...
<head>
    ...
    <title>Muhammad gabriel saviola </title>
...
<body>
    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <div class="profile">
                <img src="assets/img/portfolio/Gabrielsaviola.png=" alt="" class="img-fluid rounded-circle">
            ...
            <nav id="navbar" class="nav-menu navbar">
                <ul>
                    ...
                    <li><a href="#tentang saya" class="nav-link scrollto"><i class="bx bx-file-blank"></i> <span>Tentang
                                saya</span></a></li>
                    <li><a href="#portofolio" class="nav-link scrollto"><i class="bx bx-book-content"></i>
                            <span>Portfolio</span></a></li>
                    <li><a href="#info" class="nav-link scrollto"><i class="bx bx-server"></i> <span>info</span></a>
                    </li>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            ...
                            <ul>
                                ...
                                <li><strong>Pembuat</strong>: Gabrielsaviola</li>
                                <li><strong>Project date</strong>: 16 juni 2023</li>
                                <li><strong>Project URL</strong>: <a href="#">gabrielsaviola3@gmail.com</a></li>
                            </ul>
                        </div>
                        <div class="portfolio-description">
                            <h2>Ini adalah portofolio</h2>
                            <p>
